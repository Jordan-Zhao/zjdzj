<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.zjdzj.www.web.product" errorPage="../error.jsp"%>
...
<jsp:useBean id="down" class="com.zjdzj.www.web.DownTable" scope="page"/>
<%@ page language="java" import="java.util.*"%>    
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<%@page import="com.zjdzj.www.web.news;"%>
<html>
<head>
